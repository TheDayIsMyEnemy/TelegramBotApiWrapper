...
builder.Services.AddSingleton<ITelegramBotApiClientOptions, TelegramBotApiClientOptions>((serviceProvider) => new TelegramBotApiClientOptions { ApiKey = builder.Configuration["TelegramBotApiClientOptions:ApiKey"]! });
